...
namespace nutrition_app_backend.Migrations
{
    ...
    [Migration("20260602145602_AddPremiumSubscriptionLatestOrderId")]
    partial class AddPremiumSubscriptionLatestOrderId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("nutrition_app_backend.Models.Diaries.DailyPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("nutrition_app_backend.Models.Diaries.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("CHAR(36)");
            ...
            modelBuilder.Entity("nutrition_app_backend.Models.Diaries.MenuFood", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("CHAR(36)");
            ...
            modelBuilder.Entity("nutrition_app_backend.Models.Diaries.MenuFood", b =>
                {
                    ...
                    b.HasOne("nutrition_app_backend.Models.Diaries.Menu", "Menu")
                        .WithMany("MenuFoods")
